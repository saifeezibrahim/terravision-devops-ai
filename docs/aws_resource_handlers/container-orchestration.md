...
3. [EKS Control Plane to Node Linking](#REDACTED)
...
4. **`REDACTED`**: Split Fargate profiles across subnets (NEW)
5. **`REDACTED`**: Connect node groups to actual EC2/ASG workers
