...
2. [Security Group Processing Steps](#security-group-processing-steps)
   - [Step 1: Resolve Indirect Associations](#REDACTED)
   - [Step 2: Reverse Security Group Relationships](#REDACTED)
   - [Step 3: Move Security Groups to Subnet Level](#REDACTED)
   - [Step 4: Remove Security Groups from VPC Level](#REDACTED)
   - [Step 5: Clean Up Orphan Security Groups](#REDACTED)
3. [Security Group Matching by Suffix](#REDACTED)
